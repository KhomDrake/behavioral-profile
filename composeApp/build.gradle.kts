...
kotlin {
    ...
    listOf(
        ...
        iosTarget.binaries.framework {
            baseName = "ComposeApp"
            isStatic = true
            binaryOption("bundleId", "br.com.cosmind.app.behavioralprofile")
        }
    }
...
android {
    namespace = "br.com.cosmind.app.behavioralprofile"
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "br.com.cosmind.app.behavioralprofile"
